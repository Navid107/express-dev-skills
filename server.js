...
var skillsRouter = require('./routes/skills'); // importing the router object from ./routes/tods
...
app.use('/', indexRouter);
app.use('/skills', skillsRouter); // prepends every route in the usersRouter with /users
